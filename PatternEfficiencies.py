"""
Pattern efficiencies for patterns with total charge Qe = [2,5]e-
Paula Pérez Cobo
"""
                ...
                if  compute_p([[cdf_12]], threshold=3.5):
                    if  compute_p([[cdf_13]], threshold=3.5):
                        if  compute_p([[cdf_14]], threshold=3.5):
                            if  compute_p([[cdf_15]], threshold=3.5):
                    ...
                    if compute_p([[cdf_11, cdf_21]]): #11
                        if compute_p([[cdf_12, cdf_21], [cdf_11, cdf_22]]): #21
                            if compute_p([[cdf_13, cdf_21], [cdf_11, cdf_23]]): #31
                                if compute_p([[cdf_14, cdf_21], [cdf_11, cdf_24]]): #41
                                    if compute_p([[cdf_15, cdf_21], [cdf_11, cdf_25]]): #51
                                        complete_pattern_readen = complete_pattern_readen[3:]
                                        continue
                                    if compute_p([[cdf_14, cdf_22], [cdf_12, cdf_24]]): #42
                                        complete_pattern_readen = complete_pattern_readen[3:]
                                        continue
                                    if complete_pattern_readen[3] < qmin: #41 isolated
                                        detected_patterns.append((4, 1))
                                        complete_pattern_readen = complete_pattern_readen[3:]
                                        continue
                                if compute_p([[cdf_13, cdf_22], [cdf_12, cdf_23]]):   #32  
                                    if compute_p([[cdf_13, cdf_23]]): #33
                                        complete_pattern_readen = complete_pattern_readen[3:]
                                        continue
                                    if complete_pattern_readen[3] < qmin: #32 isolated
                                        detected_patterns.append((3, 2))
                                        complete_pattern_readen = complete_pattern_readen[3:]
                                        continue
                                if len(complete_pattern_readen) >= 5 and compute_p([[cdf_13, cdf_21, cdf_31],[cdf_11, cdf_23, cdf_31] , [cdf_11, cdf_21, cdf_33]],threshold=5.5): #311
                                    if compute_p([[cdf_13, cdf_22, cdf_31],[cdf_13, cdf_21, cdf_32],[cdf_11, cdf_22, cdf_33], 
                                                              [cdf_11, cdf_23, cdf_32], [cdf_12, cdf_21, cdf_33], [cdf_12, cdf_23, cdf_31]],threshold=5.5): #321
                                        complete_pattern_readen = complete_pattern_readen[4:]
                                        continue
                                    if complete_pattern_readen[4] < qmin and complete_pattern_readen[3] >= qmin: #311 isolated
                                        detected_patterns.append((3, 1, 1))
                                        complete_pattern_readen = complete_pattern_readen[4:]
                                        continue
                                ...
                                if len(complete_pattern_readen) >= 5 and complete_pattern_readen[3] > qmin:
                                    if compute_p([[cdf_12, cdf_21, cdf_31],[cdf_11, cdf_22, cdf_31],[cdf_11, cdf_21, cdf_32]], threshold=5.5):
                                        if complete_pattern_readen[4] < qmin: #isolation
                                            #222
                                            if compute_p([[cdf_12, cdf_22, cdf_32]], threshold=5.5):
                                                complete_pattern_readen = complete_pattern_readen[4:]
                                                continue 
                                            #221
                                            if compute_p([[cdf_12, cdf_22, cdf_31],[cdf_12, cdf_21, cdf_32] , [cdf_11, cdf_22, cdf_32]], threshold=5.5):
                                                detected_patterns.append((2, 2, 1))
                                                complete_pattern_readen = complete_pattern_readen[4:]
                                                continue 
                                            #311
                                            if compute_p([[cdf_13, cdf_21, cdf_31],[cdf_11, cdf_23, cdf_31],[cdf_11, cdf_21, cdf_33]],threshold=5.5):
                                                if compute_p([[cdf_14, cdf_21, cdf_31],[cdf_11, cdf_24, cdf_31],[cdf_11, cdf_21, cdf_34]],threshold=5.5): #411
                                                    complete_pattern_readen = complete_pattern_readen[4:]
                                                    continue
                                                if compute_p([[cdf_13, cdf_22, cdf_31],[cdf_13, cdf_21, cdf_32],[cdf_11, cdf_22, cdf_33], 
                                                              [cdf_11, cdf_23, cdf_32], [cdf_12, cdf_21, cdf_33], [cdf_12, cdf_23, cdf_31]],threshold=5.5): #321
...
file_name = f"EfficienciesBkgDC_AddedPatterns.csv"
...
efficiency_rows = compute_efficiencies(Niter=nit)
...
def probabilities_patterns(Ee, Niter=1000000, binning=False):
    """
    ...
    # Patterns studied
    allowed_patterns = [(1,), (2,), (3,), (4,), (1, 1), (2, 1), (3, 1), (2, 2), (3, 2), (4, 1), (1, 1, 1), (2, 1, 1), (3, 1, 1), (2, 2, 1)]  
...
int_prob = probabilities_patterns(0, Niter=10000000, binning=True)
output_file = os.path.join(save_directory, 'EfficienciesPatternsAddedPatterns_alpha1_4.csv')
